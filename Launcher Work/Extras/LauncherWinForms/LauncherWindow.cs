...
namespace LauncherWinForms
{
	...
	{
        // UPDATE CHECKER = 0               // 1=Update Available     //2=Up to Date

        int Update_Check = 0;


		// UPDATE THESE CONSTANTS
		private const string LAUNCHER_VERSIONINFO_URL = "https://drive.google.com/open?id=1aKZ8M82c8plqjlOiiZT7PwH2LpGy6Kqc"; // see: https://github.com/yasirkula/SimplePatchTool/wiki/Generating-versionInfoURL
		private const string MAINAPP_VERSIONINFO_URL = "https://drive.google.com/open?id=1c19OPBktUq9rnCSTlX8M5_2L-rSsvyU1"; // see: https://github.com/yasirkula/SimplePatchTool/wiki/Generating-versionInfoURL
		...
		private void CheckForUpdatesFinished()
		{
			...
			else if( patcher.Result == PatchResult.Success )
			{
                ...
                //  ButtonSetEnabled( patchButton, true );                    //UPDATE IS AVAILABLE CHANGE PLAY BUTTON TO PATCH
                playButton.Text = "UPDATE";
                Update_Check = 1;
        ...
        private void patchNotesText_TextChanged(object sender, System.EventArgs e)
        {
